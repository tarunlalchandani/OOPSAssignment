//Complex program using friend function
#include<iostream>
using namespace std;
class Complex{
	float r;
	float i;
	public :
		friend void setdata(Complex& c,float real,float imaginary);
...
void Complex::setdata(Complex& c, float real, float imaginary){
	c.r = real;
	c.i = imaginary;
}
